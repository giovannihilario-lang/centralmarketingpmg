-- ============================================================
-- PMG CONNECT — DEMANDAS V3.8.4
-- HOTFIX AUTORIA INDEPENDENTE / REPARO DE INSTALAÇÃO
-- 2026-08-24
--
...
-- Diagnóstico simples que o frontend/SQL Editor pode usar.
create or replace function public.pmg_autoria_health_v384()
returns jsonb
language sql
security definer
set search_path = ''
...
revoke all on function public.pmg_autoria_health_v384() from public, anon;
...
grant execute on function public.pmg_autoria_health_v384() to authenticated;
...
-- A última consulta deve retornar tudo TRUE/3.8.4.
select
  ...
  to_regprocedure('public.pmg_autoria_health_v384()') is not null as health_rpc_ok;
