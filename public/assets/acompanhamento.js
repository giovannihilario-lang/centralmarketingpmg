...
(() => {
  ...
  function PlanningView({ context }) {
    ...
    return html`<section className="spreadsheet-view planning-sheet-view">
      ...
      ${planning.length ? html`<div className="sheet-footnote"><${Icon} name="info"/><span>Valores do Planejamento são previsão. Editar uma célula altera o planejamento, mas não marca gasto como realizado.</span></div>` : null}
    </section>`;
  }
