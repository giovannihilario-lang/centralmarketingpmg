...
- 9 funções ativas em `api/`;
- 3 posições livres no limite do plano Hobby;
- `server.js` preservado para desenvolvimento local e ignorado no deploy da Vercel;
...
```text
OK: 9 funções Serverless. Há margem de 3 no plano Hobby.
```
